...
Characteristic.prototype.toHAP = function(opt) {
  ...
  if (this.maximumValue != null) hap.maxValue = this.maximumValue;
  if (this.minimumValue != null) hap.minValue = this.minimumValue;
  if (this.stepValue != null) hap.minStep = this.stepValue;
